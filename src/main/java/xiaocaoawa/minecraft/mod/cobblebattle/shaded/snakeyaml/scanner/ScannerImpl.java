...
import xiaocaoawa.minecraft.mod.cobblebattle.shaded.snakeyaml.reader.StreamReader;
import xiaocaoawa.minecraft.mod.cobblebattle.shaded.snakeyaml.tokens.AliasToken;
import xiaocaoawa.minecraft.mod.cobblebattle.shaded.snakeyaml.tokens.AnchorToken;
import xiaocaoawa.minecraft.mod.cobblebattle.shaded.snakeyaml.tokens.BlockEndToken;
import xiaocaoawa.minecraft.mod.cobblebattle.shaded.snakeyaml.tokens.BlockEntryToken;
import xiaocaoawa.minecraft.mod.cobblebattle.shaded.snakeyaml.tokens.BlockMappingStartToken;
import xiaocaoawa.minecraft.mod.cobblebattle.shaded.snakeyaml.tokens.BlockSequenceStartToken;
import xiaocaoawa.minecraft.mod.cobblebattle.shaded.snakeyaml.tokens.CommentToken;
import xiaocaoawa.minecraft.mod.cobblebattle.shaded.snakeyaml.tokens.DirectiveToken;
import xiaocaoawa.minecraft.mod.cobblebattle.shaded.snakeyaml.tokens.DocumentEndToken;
import xiaocaoawa.minecraft.mod.cobblebattle.shaded.snakeyaml.tokens.DocumentStartToken;
import xiaocaoawa.minecraft.mod.cobblebattle.shaded.snakeyaml.tokens.FlowEntryToken;
import xiaocaoawa.minecraft.mod.cobblebattle.shaded.snakeyaml.tokens.FlowMappingEndToken;
import xiaocaoawa.minecraft.mod.cobblebattle.shaded.snakeyaml.tokens.FlowMappingStartToken;
import xiaocaoawa.minecraft.mod.cobblebattle.shaded.snakeyaml.tokens.FlowSequenceEndToken;
import xiaocaoawa.minecraft.mod.cobblebattle.shaded.snakeyaml.tokens.FlowSequenceStartToken;
import xiaocaoawa.minecraft.mod.cobblebattle.shaded.snakeyaml.tokens.KeyToken;
import xiaocaoawa.minecraft.mod.cobblebattle.shaded.snakeyaml.tokens.ScalarToken;
import xiaocaoawa.minecraft.mod.cobblebattle.shaded.snakeyaml.tokens.StreamEndToken;
import xiaocaoawa.minecraft.mod.cobblebattle.shaded.snakeyaml.tokens.StreamStartToken;
import xiaocaoawa.minecraft.mod.cobblebattle.shaded.snakeyaml.tokens.TagToken;
import xiaocaoawa.minecraft.mod.cobblebattle.shaded.snakeyaml.tokens.TagTuple;
import xiaocaoawa.minecraft.mod.cobblebattle.shaded.snakeyaml.tokens.Token;
import xiaocaoawa.minecraft.mod.cobblebattle.shaded.snakeyaml.tokens.ValueToken;
import xiaocaoawa.minecraft.mod.cobblebattle.shaded.snakeyaml.util.ArrayStack;
import xiaocaoawa.minecraft.mod.cobblebattle.shaded.snakeyaml.util.UriEncoder;
...
public final class ScannerImpl implements Scanner {
   ...
   public boolean checkToken(Token.ID choice) {
      ...
      return !this.tokens.isEmpty() ? this.tokens.get(0).getTokenId() == choice : false;
   }
   ...
   private void scanToNextToken() {
      ...
      while (!found) {
         ...
         while (this.reader.peek(ff) == 9 && this.flowLevel > 0) {
            ff++;
         }
            ...
            if (doubleQuoted && c == 92) {
               ...
               if (!Character.isSupplementaryCodePoint(c) && ESCAPE_CODES.containsKey((char)c)) {
                  ...
                  try {
                     ...
                     throw new ScannerException(
                        "while scanning a double-quoted scalar", startMark, "found unknown escape character " + hex, this.reader.getMark()
                     );
                  }
               }
